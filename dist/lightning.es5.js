...
var __publicField = (obj, key, value) => {
  ...
  var StageUtils = /* @__PURE__ */ function() {
    ...
    return _createClass(StageUtils2, null, [{
      key: "mergeNumbers",
  ...
  var Utils$1 = /* @__PURE__ */ function() {
    ...
    return _createClass(Utils2, null, [{
      ...
      value: function isObjectLiteral(value) {
        return _typeof(value) === "object" && value && value.constructor === Object;
      }
    }, {
      key: "getArrayIndex",
  ...
  var Base = /* @__PURE__ */ function() {
    ...
    return _createClass(Base2, null, [{
      key: "defaultSetter",
  ...
  var SpacingCalculator = /* @__PURE__ */ function() {
    ...
    return _createClass(SpacingCalculator2, null, [{
      key: "getSpacing",
  ...
  var ContentAligner = /* @__PURE__ */ function() {
    ...
    return _createClass(ContentAligner2, [{
      key: "_lines",
      get: function get() {
  ...
  var FlexUtils = /* @__PURE__ */ function() {
    ...
    return _createClass(FlexUtils2, null, [{
  ...
  var SizeShrinker = /* @__PURE__ */ function() {
    ...
    return _createClass(SizeShrinker2, [{
      key: "shrink",
  ...
  var SizeGrower = /* @__PURE__ */ function() {
    ...
    return _createClass(SizeGrower2, [{
      key: "grow",
        ...
        if (totalGrowAmount) {
          ...
          do {
            ...
            for (var i = this._line.startIndex; i <= this._line.endIndex; i++) {
              ...
              if (isGrowableItem) {
                var _grow = growAmount * amountPerGrow;
                ...
                if (maxSize > 0) {
                  if (size >= maxSize) {
                    ...
                    var isFullyGrown = _grow >= maxGrow;
                    if (isFullyGrown) {
                      _grow = maxGrow;
                ...
                if (_grow > 0) {
                  var finalSize = size + _grow;
                  flexItem._resizeMainAxis(finalSize);
                  this._grownSize += _grow;
                  this._amountRemaining -= _grow;
                  if (Math.abs(this._amountRemaining) < 1e-5) {
                    return;
                  }
                }
  ...
  var ItemPositioner = /* @__PURE__ */ function() {
    ...
    return _createClass(ItemPositioner2, [{
      key: "_layout",
      get: function get() {
  ...
  var ItemAligner = /* @__PURE__ */ function() {
    ...
    return _createClass(ItemAligner2, [{
      key: "_layout",
      get: function get() {
        return this._line._layout;
      }
  ...
  var LineLayout = /* @__PURE__ */ function() {
    ...
    return _createClass(LineLayout2, [{
      key: "performLayout",
  ...
  var LineLayouter = /* @__PURE__ */ function() {
    ...
    return _createClass(LineLayouter2, [{
      key: "lines",
      get: function get() {
        return this._lines;
      }
  ...
  var ItemCoordinatesUpdater = /* @__PURE__ */ function() {
    ...
    return _createClass(ItemCoordinatesUpdater2, [{
      key: "_flexContainer",
      get: function get() {
        return this._layout._flexContainer;
      }
  ...
  var FlexLayout = /* @__PURE__ */ function() {
    ...
    return _createClass(FlexLayout2, [{
      key: "shrunk",
      get: function get() {
        return this._shrunk;
      }
  ...
  var FlexContainer = /* @__PURE__ */ function() {
    ...
    return _createClass(FlexContainer2, [{
      key: "item",
      get: function get() {
        return this._item;
      }
  ...
  var FlexTarget = /* @__PURE__ */ function() {
    ...
    return _createClass(FlexTarget2, [{
      key: "flexLayout",
      get: function get() {
  ...
  var TextureSource = /* @__PURE__ */ function() {
    ...
    return _createClass(TextureSource2, [{
      key: "hasAlpha",
      get: function get() {
  ...
  var ElementTexturizer = /* @__PURE__ */ function() {
    ...
    return _createClass(ElementTexturizer2, [{
      key: "enabled",
      get: function get() {
  ...
  var ElementCore = /* @__PURE__ */ function() {
    ...
    return _createClass(ElementCore2, [{
      key: "rtl",
      get: function get() {
        return typeof this._ownRtl === "boolean" ? this._ownRtl : this._parent ? this._parent.rtl : false;
      },
      ...
      key: "updateDirection",
      value: function updateDirection(initial) {
        var rtl = typeof this._ownRtl === "boolean" ? this._ownRtl : this._parent._rtl;
        if (rtl === this._rtl) {
          return;
        }
        this._rtl = rtl;
      ...
      value: function update() {
        ...
        if (this._hasUpdates || this._recalc && visible || w.alpha && !visible) {
          ...
          if (recalc & 6) {
            var px = this._localPx;
            var py = this._localPy;
  ...
  var ElementCoreContext = /* @__PURE__ */ function() {
    ...
    return _createClass(ElementCoreContext2, [{
      key: "isIdentity",
  ...
  var ImageTexture = /* @__PURE__ */ function(_Texture) {
    ...
    return _createClass(ImageTexture2, [{
      key: "src",
      get: function get() {
        return this._src;
      },
      ...
      key: "getNonDefaults",
      value: function getNonDefaults() {
        var obj = _superPropGet(ImageTexture2, "getNonDefaults", this, 3)([]);
        if (this._src) {
          obj.src = this._src;
        }
        return obj;
  ...
  const _TextTokenizer = class _TextTokenizer {
    ...
    static tryLoadBidiTokenizer() {
      ...
      try {
        const { getBidiTokenizer: getBidiTokenizer2 } = require("./bidiTokenizer.js");
        this._getBidiTokenizer = getBidiTokenizer2;
      } catch (e) {
        Promise.resolve().then(() => bidiTokenizer).then((module2) => {
          this._getBidiTokenizer = module2.getBidiTokenizer;
        }).catch((err) => {
    ...
    static bidiAwareTokenizer(text) {
      ...
      if (isMixed && this._getBidiTokenizer) {
        const bidiTokenizer2 = this._getBidiTokenizer();
        if (typeof bidiTokenizer2 === "function") {
          return bidiTokenizer2(text);
        } else {
          console.warn(
  ...
  function breakWord(context, word, wordWrapWidth, space = 0) {
    const result = [];
    let token = "";
    let prevWidth = 0;
  ...
  class TextTextureRenderer {
    constructor(stage, canvas, settings) {
      ...
      __publicField(this, "prevShadowSettings", null);
    ...
    draw() {
      ...
      if (!loadPromise) {
        return (
          /*Utils.isSpark ? this._stage.platform.drawText(this) :*/
          this._draw()
        );
      } else {
    ...
    _calculateRenderInfo() {
      ...
      if ((_a = linesInfo.r) == null ? void 0 : _a.length) {
      ...
      for (let i = 0; i < lines.length; i++) {
        const width2 = lines[i].width;
        lineWidths.push(width2);
        maxLineWidth = Math.max(maxLineWidth, width2);
      }
      ...
      if (h) {
        ...
        const baselineOffset = this._settings.textBaseline !== "bottom" ? fontSize * 0.5 : 0;
    ...
    _drawLines(drawLines, letterSpacing) {
    ...
    _fillTextWithLetterSpacing(ctx, text, x, y, letterSpacing) {
    ...
    _drawHighlight(precision, renderInfo, drawLines) {
  ...
  function measureLine(line) {
    var _a;
    if (((_a = line.words[line.words.length - 1]) == null ? void 0 : _a.text) === " ") {
      line.words.pop();
    }
    line.words.forEach((token) => line.width += token.width);
  }
  function createLineStyle(tags, baseFont, color) {
    const isStyled = tags.length > 0;
    let bold = 0;
    let italic = 0;
    const colors = [StageUtils.getRgbaString(color)];
    const updateStyle = (code) => {
      const tag = tags[code - 9312];
      if (!tag)
        return false;
      if (tag === "<b>") {
        bold++;
  ...
  function layoutSpans(ctx, spans, lineStyle, wrapWidth, textIndent, maxLines, suffix, wordBreak, letterSpacing, allowTruncation) {
    ...
    const appendWords = () => {
      ...
      if (line.words.length > 1) {
        if (((_a2 = words[0]) == null ? void 0 : _a2.text) === " " && ((_b = line.words[line.words.length - 1]) == null ? void 0 : _b.text) === " ") {
          words.shift();
        }
      }
      ...
      if (line.width > maxLineWidth) {
        ...
        while (line.width > maxLineWidth) {
          ...
          if (allowTruncation && maxWidth > 0) {
            let { text, width, style: style2, rtl: rtl2 } = last;
            if (style2) {
              ctx.font = style2.font;
            }
            const reversed = primaryRtl !== rtl2;
            do {
              text = reversed ? trimWordStart(text, rtl2) : trimWordEnd(text, rtl2);
  ...
  const rePunctuationStart$1 = /^[.,،:;!?؟()"“”«»-]+/;
  const rePunctuationEnd$1 = /[.,،:;!?؟()"“”«»-]+$/;
  ...
  function trimWordStart(text, rtl) {
    if (rtl) {
      return trimRtlWordStart(text);
    }
    return text.substring(1);
  }
  function trimRtlWordEnd(text) {
    let match = text.match(rePunctuationStart$1);
    if (match) {
      const punctuation = match[0];
      text = text.substring(punctuation.length);
      return punctuation.substring(1) + text;
    }
    match = text.match(rePunctuationEnd$1);
    if (match) {
      const punctuation = match[0];
  ...
  function trimRtlWordStart(text) {
    const match = text.match(rePunctuationStart$1);
    if (match) {
      const punctuation = match[0];
      text = text.substring(punctuation.length);
      if (text.length > 0) {
  ...
  var TextTexture = /* @__PURE__ */ function(_Texture) {
    ...
    return _createClass(TextTexture2, [{
      key: "text",
      get: function get() {
        return this._text;
      },
      ...
      key: "precision",
      get: function get() {
        return _superPropGet(TextTexture2, "precision", this, 1);
      },
      set: function set2(v) {
        if (this.precision !== v) {
          _superPropSet(TextTexture2, "precision", v, this, 1, 1);
          this._changed();
        }
      }
    }, {
      ...
      key: "getNonDefaults",
      value: function getNonDefaults() {
        var nonDefaults = _superPropGet(TextTexture2, "getNonDefaults", this, 3)([]);
        if (this.text !== "")
  ...
  var SourceTexture = /* @__PURE__ */ function(_Texture) {
    ...
    return _createClass(SourceTexture2, [{
      key: "textureSource",
      get: function get() {
  ...
  var Transition = /* @__PURE__ */ function(_EventEmitter) {
    ...
    return _createClass(Transition2, [{
      key: "start",
  ...
  var ObjectList = /* @__PURE__ */ function() {
    ...
    return _createClass(ObjectList2, [{
      key: "get",
      value: function get() {
        return this._items;
      }
  ...
  var ElementChildList = /* @__PURE__ */ function(_ObjectList) {
    ...
    return _createClass(ElementChildList2, [{
      key: "_connectParent",
  ...
  var Element = /* @__PURE__ */ function() {
    ...
    return _createClass(Element2, [{
      ...
      value: function _updateDirection(rtl) {
      ...
      key: "_onDirectionChanged",
      value: function _onDirectionChanged() {
      }
    }, {
      key: "_getRenderWidth",
      ...
      value: function enableTextTexture() {
        if (!this.texture || !(this.texture instanceof TextTexture)) {
          ...
          this.texture.rtl = this.__core._rtl;
  ...
  var StateMachine = /* @__PURE__ */ function() {
    ...
    return _createClass(StateMachine2, [{
      key: "fire",
  ...
  var StateMachineType = /* @__PURE__ */ function() {
    ...
    return _createClass(StateMachineType2, [{
      key: "router",
      get: function get() {
        return this._router;
      }
  ...
  var Component = /* @__PURE__ */ function(_Element) {
    function Component2(stage, properties) {
      ...
      _this.__construct();
      var func = _this.constructor.getTemplateFunc(_this);
      func.f(_this, func.a);
      _this._build();
      return _this;
    }
    _inherits(Component2, _Element);
    return _createClass(Component2, [{
      key: "__start",
      value: function __start() {
  ...
  var CoreQuadList = /* @__PURE__ */ function() {
    ...
    return _createClass(CoreQuadList2, [{
      key: "length",
      get: function get() {
  ...
  var WebGLCoreQuadList = /* @__PURE__ */ function(_CoreQuadList) {
    ...
    return _createClass(WebGLCoreQuadList2, [{
  ...
  var CoreQuadOperation = /* @__PURE__ */ function() {
    ...
    return _createClass(CoreQuadOperation2, [{
      key: "quads",
      get: function get() {
  ...
  var WebGLCoreQuadOperation = /* @__PURE__ */ function(_CoreQuadOperation) {
    ...
    return _createClass(WebGLCoreQuadOperation2, [{
      key: "getAttribsDataByteOffset",
      value: function getAttribsDataByteOffset(index) {
  ...
  var CoreRenderExecutor = /* @__PURE__ */ function() {
    ...
    return _createClass(CoreRenderExecutor2, [{
      key: "destroy",
  ...
  var WebGLCoreRenderExecutor = /* @__PURE__ */ function(_CoreRenderExecutor) {
    ...
    return _createClass(WebGLCoreRenderExecutor2, [{
      key: "init",
      value: function init() {
        var gl = this.gl;
      ...
      key: "destroy",
      value: function destroy() {
        _superPropGet(WebGLCoreRenderExecutor2, "destroy", this, 3)([]);
      ...
      key: "_reset",
      value: function _reset() {
        _superPropGet(WebGLCoreRenderExecutor2, "_reset", this, 3)([]);
        var gl = this.gl;
      ...
      key: "_setupQuadOperation",
      value: function _setupQuadOperation(quadOperation) {
        _superPropGet(WebGLCoreRenderExecutor2, "_setupQuadOperation", this, 3)([quadOperation]);
      ...
      key: "_bindRenderTexture",
      value: function _bindRenderTexture(renderTexture) {
        _superPropGet(WebGLCoreRenderExecutor2, "_bindRenderTexture", this, 3)([renderTexture]);
        var gl = this.gl;
        if (!this._renderTexture) {
      ...
      value: function _clearRenderTexture() {
        _superPropGet(WebGLCoreRenderExecutor2, "_clearRenderTexture", this, 3)([]);
        var gl = this.gl;
        if (!this._renderTexture) {
      ...
      key: "_setScissor",
      value: function _setScissor(area) {
        _superPropGet(WebGLCoreRenderExecutor2, "_setScissor", this, 3)([area]);
  ...
  var CoreRenderState = /* @__PURE__ */ function() {
    ...
    return _createClass(CoreRenderState2, [{
      key: "reset",
      value: function reset() {
  ...
  var WebGLShaderProgram = /* @__PURE__ */ function() {
    ...
    return _createClass(WebGLShaderProgram2, [{
      key: "compile",
  ...
  var WebGLShader = /* @__PURE__ */ function(_Shader) {
    ...
    return _createClass(WebGLShader2, [{
      key: "glProgram",
      get: function get() {
  ...
  var DefaultShader$1 = /* @__PURE__ */ function(_WebGLShader) {
    ...
    return _createClass(DefaultShader2, [{
      key: "enableAttribs",
      value: function enableAttribs() {
        var gl = this.gl;
  ...
  var WebGLRenderer = /* @__PURE__ */ function(_Renderer) {
    ...
    return _createClass(WebGLRenderer2, [{
  ...
  var C2dCoreQuadList = /* @__PURE__ */ function(_CoreQuadList) {
    ...
    return _createClass(C2dCoreQuadList2, [{
  ...
  var C2dCoreQuadOperation = /* @__PURE__ */ function(_CoreQuadOperation) {
    ...
    return _createClass(C2dCoreQuadOperation2, [{
      key: "getRenderContext",
      value: function getRenderContext(index) {
  ...
  var C2dCoreRenderExecutor = /* @__PURE__ */ function(_CoreRenderExecutor) {
    ...
    return _createClass(C2dCoreRenderExecutor2, [{
      key: "init",
      value: function init() {
  ...
  var C2dShader = /* @__PURE__ */ function(_Shader) {
    ...
    return _createClass(C2dShader2, [{
      key: "beforeDraw",
      value: function beforeDraw(operation) {
      }
    }, {
  ...
  var C2dTextureTintManager = /* @__PURE__ */ function() {
    ...
    return _createClass(C2dTextureTintManager2, [{
      key: "destroy",
      value: function destroy() {
        this.gc(true);
        this.stage = null;
  ...
  var C2dTintCache = /* @__PURE__ */ function() {
    ...
    return _createClass(C2dTintCache2, [{
      key: "memoryUsage",
      get: function get() {
  ...
  var C2dRenderer = /* @__PURE__ */ function(_Renderer) {
    ...
    return _createClass(C2dRenderer2, [{
      key: "destroy",
      value: function destroy() {
  ...
  var SparkShader = /* @__PURE__ */ function(_WebGLShader) {
    ...
    return _createClass(SparkShader2, [{
      key: "enableAttribs",
      value: function enableAttribs() {
        var gl = this.gl;
        gl.vertexAttribPointer(this._attrib("aVertexPosition"), 2, gl.FLOAT, false, 20, 0);
  ...
  var SparkRenderer = /* @__PURE__ */ function(_WebGLRenderer) {
    ...
    return _createClass(SparkRenderer2, [{
      key: "_createDefaultShader",
      value: function _createDefaultShader(ctx) {
      ...
      value: function createCoreRenderExecutor(ctx) {
        global.beginDrawing();
        var ret = _superPropGet(SparkRenderer2, "createCoreRenderExecutor", this, 3)([ctx]);
        global.endDrawing();
        return ret;
      }
    }]);
  ...
  var ImageWorker = /* @__PURE__ */ function() {
    ...
    return _createClass(ImageWorker2, [{
      key: "destroy",
      value: function destroy() {
        if (this._worker) {
  ...
  var ImageWorkerImage = /* @__PURE__ */ function() {
    ...
    return _createClass(ImageWorkerImage2, [{
      key: "id",
      get: function get() {
        return this._id;
      }
  ...
  var WebPlatform = /* @__PURE__ */ function() {
    ...
    return _createClass(WebPlatform2, [{
      key: "init",
  ...
  var PlatformLoader = /* @__PURE__ */ function() {
    ...
    return _createClass(PlatformLoader2, null, [{
      key: "load",
  ...
  var WebGLState = /* @__PURE__ */ function() {
    ...
    return _createClass(WebGLState2, [{
      key: "_getDefaultFlag",
  ...
  var WebGLStateManager = /* @__PURE__ */ function() {
    ...
    return _createClass(WebGLStateManager2, [{
  ...
  var TextureManager = /* @__PURE__ */ function() {
    ...
    return _createClass(TextureManager2, [{
      key: "usedMemory",
      get: function get() {
  ...
  var TextureThrottler = /* @__PURE__ */ function() {
    ...
    return _createClass(TextureThrottler2, [{
      key: "destroy",
      value: function destroy() {
        this._sources = [];
        this._data = [];
  ...
  var CoreContext = /* @__PURE__ */ function() {
    ...
    return _createClass(CoreContext2, [{
      key: "usedMemory",
      get: function get() {
        return this._usedMemory;
      }
  ...
  var TransitionSettings = /* @__PURE__ */ function() {
    ...
    return _createClass(TransitionSettings2, [{
      key: "timingFunction",
      get: function get() {
  ...
  var TransitionManager = /* @__PURE__ */ function() {
    ...
    return _createClass(TransitionManager2, [{
      key: "progress",
  ...
  var MultiSpline = /* @__PURE__ */ function() {
    ...
    return _createClass(MultiSpline2, [{
      key: "_clear",
  ...
  var AnimationActionSettings = /* @__PURE__ */ function() {
    ...
    return _createClass(AnimationActionSettings2, [{
      key: "getResetValue",
  ...
  var AnimationSettings = /* @__PURE__ */ function() {
    ...
    return _createClass(AnimationSettings2, [{
      key: "actions",
      get: function get() {
  ...
  var AnimationManager = /* @__PURE__ */ function() {
    ...
    return _createClass(AnimationManager2, [{
      key: "progress",
      value: function progress() {
        var _this2 = this;
        if (this.active.size) {
  ...
  var RectangleTexture = /* @__PURE__ */ function(_Texture) {
    ...
    return _createClass(RectangleTexture2, [{
      key: "_getLookupId",
      value: function _getLookupId() {
        return "__whitepix";
      }
  ...
  var Stage = /* @__PURE__ */ function(_EventEmitter) {
    function Stage2() {
      ...
      if (_this._mode === 0) {
        if (Utils$1.isSpark) {
          _this._renderer = new SparkRenderer(_this);
        } else {
          _this._renderer = new WebGLRenderer(_this);
        }
      } else {
        _this._renderer = new C2dRenderer(_this);
      }
      _this.setClearColor(_this.getOption("clearColor"));
      _this.frameCounter = 0;
      _this.transitions = new TransitionManager(_this);
      _this.animations = new AnimationManager(_this);
      _this.textureManager = new TextureManager(_this);
      _this.textureThrottler = new TextureThrottler(_this);
      _this.startTime = 0;
      _this.currentTime = 0;
      _this.dt = 0;
      _this.rectangleTexture = new RectangleTexture(_this);
      _this.rectangleTexture.load();
      _this.rectangleTexture.source.permanent = true;
      _this.ctx = new CoreContext(_this);
  ...
  var Application = /* @__PURE__ */ function(_Component) {
    ...
    return _createClass(Application2, [{
      key: "getOption",
      value: function getOption(name) {
      ...
      value: function __construct() {
        ...
        _superPropGet(Application2, "__construct", this, 3)([]);
      }
    }, {
      key: "__init",
      value: function __init() {
        _superPropGet(Application2, "__init", this, 3)([]);
        this.__updateFocus();
      }
    }, {
      key: "updateFocusPath",
      ...
      key: "getDirectionAwareEvents",
      value: function getDirectionAwareEvents(events) {
        if (events.length > 0) {
          if (events[0].indexOf("Left") > 0) {
            return {
              eventsLtr: events,
              eventsRtl: [events[0].replace("Left", "Right")].concat(_toConsumableArray(events.slice(1))),
              isHorizontalDirection: true
            };
          } else if (events[0].indexOf("Right") > 0) {
            return {
              eventsLtr: events,
              eventsRtl: [events[0].replace("Right", "Left")].concat(_toConsumableArray(events.slice(1))),
              isHorizontalDirection: true
            };
          }
        }
      ...
      value: function focusTopDownEvent(events) {
        ...
        var n = path.length;
        var _this$getDirectionAwa = this.getDirectionAwareEvents(events), eventsLtr = _this$getDirectionAwa.eventsLtr, eventsRtl = _this$getDirectionAwa.eventsRtl, isHorizontalDirection = _this$getDirectionAwa.isHorizontalDirection;
        for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
          args[_key - 1] = arguments[_key];
        }
        for (var i = 0; i < n; i++) {
          var target = path[i];
          var _events = isHorizontalDirection && target.rtl ? eventsRtl : eventsLtr;
          var event = target._getMostSpecificHandledMember(_events);
          if (event !== void 0) {
            var returnValue = target[event].apply(target, args);
      ...
      value: function focusBottomUpEvent(events) {
        var path = this.focusPath;
        var n = path.length;
        var _this$getDirectionAwa2 = this.getDirectionAwareEvents(events), eventsLtr = _this$getDirectionAwa2.eventsLtr, eventsRtl = _this$getDirectionAwa2.eventsRtl, isHorizontalDirection = _this$getDirectionAwa2.isHorizontalDirection;
        for (var _len2 = arguments.length, args = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
          args[_key2 - 1] = arguments[_key2];
        }
        for (var i = n - 1; i >= 0; i--) {
          var target = path[i];
          var _events2 = isHorizontalDirection && target.rtl ? eventsRtl : eventsLtr;
          var event = target._getMostSpecificHandledMember(_events2);
          if (event !== void 0) {
            var returnValue = target[event].apply(target, args);
            if (returnValue !== false) {
              return true;
      ...
      value: function _receiveKeydown(e) {
        ...
        if (keys) {
          for (var i = 0, n = keys.length; i < n; i++) {
            var _key3 = keys[i];
            var hasTimer = this.__keypressTimers.has(_key3);
            if (path[path.length - 1].longpress && hasTimer) {
              return;
            }
            if (!this.focusTopDownEvent(["_capture".concat(_key3), "_captureKey"], obj)) {
              this.focusBottomUpEvent(["_handle".concat(_key3), "_handleKey"], obj);
            }
          }
        } else {
      ...
      value: function _receiveKeyup(e) {
        ...
        if (keys) {
          for (var i = 0, n = keys.length; i < n; i++) {
            var _key4 = keys[i];
            if (!this.focusTopDownEvent(["_capture".concat(_key4, "Release"), "_captureKeyRelease"], obj)) {
              this.focusBottomUpEvent(["_handle".concat(_key4, "Release"), "_handleKeyRelease"], obj);
            }
          }
        } else {
        ...
        if (config[lookup]) {
          ...
          if (!Utils$1.isNumber(timeout)) {
            ...
            this.__keypressTimers.set(key, setTimeout((function() {
              _newArrowCheck(this, _this4);
              if (!this.focusTopDownEvent(["_capture".concat(key, "Long"), "_captureKey"], {})) {
                this.focusBottomUpEvent(["_handle".concat(key, "Long"), "_handleKey"], {});
              }
  ...
  var StaticCanvasTexture = /* @__PURE__ */ function(_Texture) {
    ...
    return _createClass(StaticCanvasTexture2, [{
      key: "content",
      set: function set2(_ref) {
  ...
  var Tools = /* @__PURE__ */ function() {
    ...
    return _createClass(Tools2, null, [{
  ...
  var ObjMerger = /* @__PURE__ */ function() {
    ...
    return _createClass(ObjMerger2, null, [{
      key: "isMf",
  ...
  var ObjectListProxy = /* @__PURE__ */ function(_ObjectList) {
    ...
    return _createClass(ObjectListProxy2, [{
      key: "onAdd",
      value: function onAdd(item, index) {
  ...
  var ObjectListWrapper = /* @__PURE__ */ function(_ObjectListProxy) {
    ...
    return _createClass(ObjectListWrapper2, [{
      key: "wrap",
      ...
      value: function onAdd(item, index) {
        item = this.wrap(item);
        _superPropGet(ObjectListWrapper2, "onAdd", this, 3)([item, index]);
      }
    }, {
      key: "onRemove",
      value: function onRemove(item, index) {
        _superPropGet(ObjectListWrapper2, "onRemove", this, 3)([item, index]);
      }
    }, {
      key: "onSync",
      value: function onSync(removed, added, order) {
        ...
        _superPropGet(ObjectListWrapper2, "onSync", this, 3)([removed, added, order]);
      }
    }, {
      key: "onSet",
      value: function onSet(item, index) {
        item = this.wrap(item);
        _superPropGet(ObjectListWrapper2, "onSet", this, 3)([item, index]);
      }
    }, {
      key: "onMove",
      value: function onMove(item, fromIndex, toIndex) {
        _superPropGet(ObjectListWrapper2, "onMove", this, 3)([item, fromIndex, toIndex]);
      }
    }]);
  }(ObjectListProxy);
  var NoiseTexture = /* @__PURE__ */ function(_Texture) {
    ...
    return _createClass(NoiseTexture2, [{
      key: "_getLookupId",
      value: function _getLookupId() {
        return "__noise";
      }
  ...
  var HtmlTexture = /* @__PURE__ */ function(_Texture) {
    ...
    return _createClass(HtmlTexture2, [{
      key: "htmlElement",
      get: function get() {
  ...
  var StaticTexture = /* @__PURE__ */ function(_Texture) {
    ...
    return _createClass(StaticTexture2, [{
      key: "options",
      get: function get() {
  ...
  var ListComponent = /* @__PURE__ */ function(_Component) {
    function ListComponent2(stage) {
      ...
      _this._wrapper = _superPropGet(ListComponent2, "_children", _this, 1).a({});
      ...
      _this.itemList = new ListItems(_this);
      return _this;
    }
    _inherits(ListComponent2, _Component);
    return _createClass(ListComponent2, [{
      key: "_allowChildrenAccess",
      value: function _allowChildrenAccess() {
        return false;
      }
  ...
  var ListItems = /* @__PURE__ */ function(_ObjectListWrapper) {
    ...
    return _createClass(ListItems2, [{
      key: "onAdd",
      value: function onAdd(item, index) {
        _superPropGet(ListItems2, "onAdd", this, 3)([item, index]);
      ...
      key: "onRemove",
      value: function onRemove(item, index) {
        _superPropGet(ListItems2, "onRemove", this, 3)([item, index]);
      ...
      key: "onSet",
      value: function onSet(item, index) {
        _superPropGet(ListItems2, "onSet", this, 3)([item, index]);
        this.checkStarted(index);
      }
    }, {
      key: "onSync",
      value: function onSync(removed, added, order) {
        _superPropGet(ListItems2, "onSync", this, 3)([removed, added, order]);
        this.checkStarted(0);
      }
    }, {
      key: "_signalProxy",
  ...
  var LinearBlurShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(LinearBlurShader2, [{
      key: "x",
      get: function get() {
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(LinearBlurShader2, "setupUniforms", this, 3)([operation]);
  ...
  var BoxBlurShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(BoxBlurShader2, [{
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(BoxBlurShader2, "setupUniforms", this, 3)([operation]);
  ...
  var BlurShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(BlurShader2, [{
      key: "kernelRadius",
      get: function get() {
        return this._kernelRadius;
      },
  ...
  var FastBlurComponent = /* @__PURE__ */ function(_Component) {
    ...
    return _createClass(FastBlurComponent2, [{
      key: "wrap",
      get: function get() {
  ...
  var C2dFastBlurComponent = /* @__PURE__ */ function(_Component2) {
    ...
    return _createClass(C2dFastBlurComponent2, [{
      key: "content",
      get: function get() {
  ...
  var WebGLFastBlurComponent = /* @__PURE__ */ function(_Component3) {
    ...
    return _createClass(WebGLFastBlurComponent2, [{
      key: "_signalProxy",
      get: function get() {
        return true;
      }
      ...
      key: "shader",
      set: function set2(s) {
        _superPropSet(WebGLFastBlurComponent2, "shader", s, this, 1, 1);
  ...
  var FastBlurOutputShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(FastBlurOutputShader2, [{
      key: "a",
      get: function get() {
        return this._a;
      },
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(FastBlurOutputShader2, "setupUniforms", this, 3)([operation]);
  ...
  var BloomComponent = /* @__PURE__ */ function(_Component) {
    ...
    return _createClass(BloomComponent2, [{
      key: "_signalProxy",
      get: function get() {
        return true;
      }
      ...
      key: "shader",
      set: function set2(s) {
        _superPropSet(BloomComponent2, "shader", s, this, 1, 1);
        if (!this.renderToTexture) {
          console.warn("[Lightning] Please enable renderToTexture to use with a shader.");
        }
      }
  ...
  var SmoothScaleComponent = /* @__PURE__ */ function(_Component) {
    ...
    return _createClass(SmoothScaleComponent2, [{
      key: "content",
      get: function get() {
  ...
  var BorderComponent = /* @__PURE__ */ function(_Component) {
    ...
    return _createClass(BorderComponent2, [{
      key: "_signalProxy",
      get: function get() {
        return true;
      }
  ...
  var WebGLGrayscaleShader = /* @__PURE__ */ function(_WebGLDefaultShader) {
    ...
    return _createClass(WebGLGrayscaleShader2, [{
      key: "amount",
      get: function get() {
        return this._amount;
      },
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(WebGLGrayscaleShader2, "setupUniforms", this, 3)([operation]);
  ...
  var C2dGrayscaleShader = /* @__PURE__ */ function(_C2dDefaultShader) {
    ...
    return _createClass(C2dGrayscaleShader2, [{
      key: "amount",
      get: function get() {
        return this._amount;
      },
  ...
  var DitheringShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(DitheringShader2, [{
      key: "graining",
      set: function set2(v) {
        this._graining = v;
        this.redraw();
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(DitheringShader2, "setupUniforms", this, 3)([operation]);
      ...
      key: "enableAttribs",
      value: function enableAttribs() {
        _superPropGet(DitheringShader2, "enableAttribs", this, 3)([]);
        var gl = this.gl;
      ...
      key: "disableAttribs",
      value: function disableAttribs() {
        _superPropGet(DitheringShader2, "disableAttribs", this, 3)([]);
        var gl = this.gl;
  ...
  var CircularPushShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(CircularPushShader2, [{
      key: "aspectRatio",
      get: function get() {
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(CircularPushShader2, "setupUniforms", this, 3)([operation]);
  ...
  var InversionShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(InversionShader2, [{
      key: "amount",
      get: function get() {
        return this._amount;
      },
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(InversionShader2, "setupUniforms", this, 3)([operation]);
        this._setUniform("amount", this._amount, this.gl.uniform1f);
      }
    }]);
  }(DefaultShader$1);
  ...
  var OutlineShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(OutlineShader2, [{
      key: "width",
      set: function set2(v) {
        this._width = v;
        this.redraw();
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(OutlineShader2, "setupUniforms", this, 3)([operation]);
        var gl = this.gl;
      ...
      key: "enableAttribs",
      value: function enableAttribs() {
        _superPropGet(OutlineShader2, "enableAttribs", this, 3)([]);
        this.gl.enableVertexAttribArray(this._attrib("aCorner"));
      }
    }, {
      key: "disableAttribs",
      value: function disableAttribs() {
        _superPropGet(OutlineShader2, "disableAttribs", this, 3)([]);
  ...
  var PixelateShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(PixelateShader2, [{
      key: "x",
      get: function get() {
        return this._size[0];
      },
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(PixelateShader2, "setupUniforms", this, 3)([operation]);
        var gl = this.gl;
      ...
      key: "enableAttribs",
      value: function enableAttribs() {
        _superPropGet(PixelateShader2, "enableAttribs", this, 3)([]);
        this.gl.enableVertexAttribArray(this._attrib("aTextureRes"));
      }
    }, {
      key: "disableAttribs",
      value: function disableAttribs() {
        _superPropGet(PixelateShader2, "disableAttribs", this, 3)([]);
  ...
  var RadialFilterShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(RadialFilterShader2, [{
      key: "radius",
      get: function get() {
        return this._radius;
      },
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(RadialFilterShader2, "setupUniforms", this, 3)([operation]);
  ...
  var RoundedRectangleShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(RoundedRectangleShader2, [{
      key: "blend",
      get: function get() {
        return this._blend;
      },
      ...
      value: function setupUniforms(operation) {
        var _this2 = this;
        _superPropGet(RoundedRectangleShader2, "setupUniforms", this, 3)([operation]);
  ...
  var FadeOutShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(FadeOutShader2, [{
      key: "top",
      get: function get() {
        return this._fade[0];
      },
      ...
      value: function setupUniforms(operation) {
        var _this2 = this;
        _superPropGet(FadeOutShader2, "setupUniforms", this, 3)([operation]);
        var owner = operation.shaderOwner;
        var renderPrecision = this.ctx.stage.getRenderPrecision();
  ...
  var VignetteShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(VignetteShader2, [{
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(VignetteShader2, "setupUniforms", this, 3)([operation]);
  ...
  var SpinnerShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(SpinnerShader3, [{
      key: "radius",
      set: function set2(v) {
        this._radius = v;
        this.redraw();
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(SpinnerShader3, "setupUniforms", this, 3)([operation]);
        var owner = operation.shaderOwner;
  ...
  var HoleShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(HoleShader2, [{
      key: "x",
      get: function get() {
        return this._x;
      },
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(HoleShader2, "setupUniforms", this, 3)([operation]);
        var owner = operation.shaderOwner;
        var renderPrecision = this.ctx.stage.getRenderPrecision();
  ...
  var RadialGradientShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(RadialGradientShader2, [{
      key: "radiusX",
      get: function get() {
        return this._radius;
      },
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(RadialGradientShader2, "setupUniforms", this, 3)([operation]);
        var owner = operation.shaderOwner;
        if (this._x) {
  ...
  var Light3dShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(Light3dShader2, [{
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(Light3dShader2, "setupUniforms", this, 3)([operation]);
  ...
  var PerspectiveShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(PerspectiveShader2, [{
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(PerspectiveShader2, "setupUniforms", this, 3)([operation]);
        var vr = operation.shaderOwner;
        var element = vr.element;
  ...
  var MagnifierShader = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(MagnifierShader2, [{
      key: "x",
      get: function get() {
        return this._x;
      },
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(MagnifierShader2, "setupUniforms", this, 3)([operation]);
        var owner = operation.shaderOwner;
        var renderPrecision = this.ctx.stage.getRenderPrecision();
        this._setUniform("x", this._x * renderPrecision, this.gl.uniform1f);
        this._setUniform("y", this._y * renderPrecision, this.gl.uniform1f);
  ...
  var SpinnerShader2 = /* @__PURE__ */ function(_DefaultShader) {
    ...
    return _createClass(SpinnerShader22, [{
      key: "radius",
      set: function set2(v) {
        if (v === 0) {
          v = 1;
      ...
      key: "setupUniforms",
      value: function setupUniforms(operation) {
        _superPropGet(SpinnerShader22, "setupUniforms", this, 3)([operation]);
        var owner = operation.shaderOwner;
  ...
  function bidiFactory() {
    var bidi2 = function(exports2) {
      ...
      function getEmbeddingLevels(string, baseDirection) {
        ...
        var nextEven = function nextEven2(n) {
          return n + (n & 1 ? 1 : 2);
        };
        var nextOdd = function nextOdd2(n) {
          return n + (n & 1 ? 2 : 1);
        };
  ...
  const bidiTokenizer = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    getBidiTokenizer
