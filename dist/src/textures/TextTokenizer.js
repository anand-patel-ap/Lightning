...
class TextTokenizer {
    ...
    static isRTLCharacter(codePoint) {
        ...
        // Other RTL scripts
        if ((codePoint >= 0x07c0 && codePoint <= 0x07ff) || // NKo
    ...
    static isLTRCharacter(codePoint) {
        ...
        if ((codePoint >= 0x00c0 && codePoint <= 0x024f) || // Latin Extended-A & B
        ...
        if ((codePoint >= 0x0100 && codePoint <= 0x017f) || // Latin Extended-A
