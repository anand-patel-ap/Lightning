...
export default class TextTextureRenderer {
    ...
    setFontProperties() {
        this._context.font = getFontSetting(this._settings.fontFace, this._settings.fontStyle, this._settings.fontSize, this._stage.getRenderPrecision(), this._stage.getOption("defaultFontFace"));
        this._context.textBaseline = this._settings.textBaseline;
    }
    _load() {
        if ( /*Utils.isWeb &&*/document.fonts) {
            const fontSetting = getFontSetting(this._settings.fontFace, this._settings.fontStyle, this._settings.fontSize, this._stage.getRenderPrecision(), this._stage.getOption("defaultFontFace"));
            try {
...
//# sourceMappingURL=TextTextureRenderer.js.map